...
(function () { return __awaiter(_this, void 0, void 0, function () {
    var express, cors, bodyParser, logger, API_PORT_1, app_1, router, dbRoute, client, dbName, db_1, cars_1, e_3;
    var _this = this;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 4:
                ...
                app_1.use(bodyParser.urlencoded({ extended: false }));
                app_1.use(bodyParser.json());
                app_1.use(logger("dev"));
                ...
                app_1.use("/api", router);
                // launch our backend into a port
                app_1.listen(API_PORT_1, function () { return console.log("LISTENING ON PORT " + API_PORT_1); });
                return [3 /*break*/, 6];
            case 5:
                e_3 = _a.sent();
                console.error(e_3);
